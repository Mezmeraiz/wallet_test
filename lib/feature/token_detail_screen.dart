...
class TokenDetailScreen extends StatelessWidget {
  final MapEntry<String, String> tokenInfo;

  const TokenDetailScreen({super.key, required this.tokenInfo});
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            FutureBuilder(
              future: DependencyScope.of(context).tokenService.getTokenBalance(tokenInfo),
